...
import { BaseShader, WaterShader } from "../graphics/shader";
...
export class Water {
    ...
    constructor(tileSize: number, numTilesX: number, numTilesZ: number, 
        ...
        texImage.src = "assests/planets/earth/day.jpg";
